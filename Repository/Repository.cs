...
namespace Repository
{
    ...
    public class Repository<T> : IRepository<T> where T : new()
    {
        ...
        /// <returns></returns>
        public DataTable FindTablePageByProc(string procName, DbParameter[] parameters, ref JqGridParam jqgridparam)
        {
            string orderField = jqgridparam.sidx;
            string orderType = jqgridparam.sord;
            int pageIndex = jqgridparam.page;
            int pageSize = jqgridparam.rows;
            int totalRow = jqgridparam.records;
            DataTable dt = DataFactory.Database().FindTablePageByProc(procName, parameters, orderField, orderType, pageIndex, pageSize, ref totalRow);
            jqgridparam.records = totalRow;
            return dt;
        }
    }
