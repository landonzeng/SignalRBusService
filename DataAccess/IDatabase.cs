...
namespace DataAccess
{
    ...
    public interface IDatabase : IDisposable
    {
        ...
        object ExecuteScalar(CommandType commandType, string commandText, DbParameter[] parameters);
        DataTable QueryToDataTable(string commandText, CommandType commandType, DbParameter[] parameters);
        DataTable FindTablePageByProc(string procName, DbParameter[] param, string orderField, string orderType, int pageIndex, int pageSize, ref int count);
    }
}
