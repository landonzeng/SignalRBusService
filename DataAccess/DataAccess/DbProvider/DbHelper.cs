...
namespace DataAccess
{
    ...
    public class DbHelper
    {
        ...
        public static int ExecuteNonQuery(CommandType cmdType, string cmdText)
        {
            ...
            {
                num = -1;
                log.Error(ex.Message + "SQL:" + cmdText);
                throw;
            }
            finally
            {
        ...
        public static int ExecuteNonQuery(CommandType cmdType, string cmdText, params DbParameter[] parameters)
        {
            ...
            {
                num = -1;
                log.Error(ex.Message + "SQL:" + cmdText + parameters);
                throw;
            }
            finally
            {
        ...
        /// <returns></returns>
        public static DataTable QueryToDataTable(string commandText, CommandType commandType,DbParameter[] parameters)
        {
