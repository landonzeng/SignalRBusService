...
namespace Utilities
{
    ...
    public class LogFactory
    {
        static LogFactory()
        {
            FileInfo configFile = new FileInfo(AppDomain.CurrentDomain.BaseDirectory + "\\XmlConfig\\log4net.config");

            if (HttpContext.Current != null) //web访问方式
            {
                configFile = new FileInfo(HttpContext.Current.Server.MapPath("/XmlConfig/log4net.config"));
            }
